...
from model_behavior_research.scientific.intervention_math import (
    context_delta,
    interaction,
    matched_contrast,
    null_projector,
...
from model_behavior_research.scientific.intervention_prepare import bucket
from model_behavior_research.scientific.intervention_run import NativeProbe, audit_cells
...
def test_runner_checkpoint_on_tiny_native_model(tmp_path, monkeypatch):
    ...
    from model_behavior_research.scientific.collect import sha256
    from model_behavior_research.scientific.intervention_run import run

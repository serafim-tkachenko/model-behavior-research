...
from model_behavior_research.scientific.collect import collect, configuration, sha256
from model_behavior_research.scientific.regimes import RegimeConfig, analyze_feature, bh_adjust
from model_behavior_research.scientific.run import analyze
...
def confirm_sources(cfg, rcfg):
    ...
    from model_behavior_research.scientific.regimes import require_regime_config

...
from model_behavior_research.scientific.geometry_analysis import load_residuals, permutation_shift
from model_behavior_research.scientific.regimes import RegimeConfig, _strata, bh_adjust

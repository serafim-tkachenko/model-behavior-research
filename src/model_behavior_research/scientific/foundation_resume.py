...
from model_behavior_research.scientific import regimes
from model_behavior_research.scientific.foundation import settings
from model_behavior_research.scientific.geometry_primary import GroupedPermuter
...
def main(layer):
    ...
    gc.collect()
    from model_behavior_research.scientific import controls

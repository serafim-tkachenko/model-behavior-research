...
appendix are adjacent. Artifact locations are listed in `artifacts/README.md`.
...
```bash
python -m model_behavior_research.scientific.foundation --layer 17 --stage analyze
python -m model_behavior_research.scientific.foundation --layer 22 --stage analyze
python -m model_behavior_research.scientific.foundation --layer 17 --stage controls
python -m model_behavior_research.scientific.foundation --layer 22 --stage controls
python -m model_behavior_research.scientific.geometry_plan --layer 17
python -m model_behavior_research.scientific.geometry_plan --layer 22
python -m model_behavior_research.scientific.geometry_primary --layer 17
python -m model_behavior_research.scientific.geometry_primary --layer 22
python -m model_behavior_research.scientific.geometry_replay
python -m model_behavior_research.scientific.geometry_analysis --layer 17
python -m model_behavior_research.scientific.geometry_analysis --layer 22
python -m model_behavior_research.scientific.geometry_coverage --layer 17
python -m model_behavior_research.scientific.geometry_coverage --layer 22
python -m model_behavior_research.scientific.geometry_examples --layer 17
python -m model_behavior_research.scientific.geometry_examples --layer 22
python -m model_behavior_research.scientific.geometry_audit --layer 17
python -m model_behavior_research.scientific.geometry_audit --layer 22
python -m model_behavior_research.scientific.geometry_consistency --layer 17
python -m model_behavior_research.scientific.geometry_consistency --layer 22
```

The exploratory encoder diagnostic is invoked separately with
`python -m model_behavior_research.scientific.geometry_encoder_control --layer 17`

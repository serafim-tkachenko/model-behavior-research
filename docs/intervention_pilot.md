...
```bash
OMP_NUM_THREADS=4 python -m model_behavior_research.scientific.intervention_prepare \
...
```bash
python -m model_behavior_research.scientific.intervention_run \
...
python -m model_behavior_research.scientific.intervention_analysis \
